...
public class Game {
	...
	public void reset(int currentTurn, int numConsecutivePassedTurns, boolean wordsInBoard,
		...
		this.server.sendViewAction(GameSerializer.serializeReset(board, this.getNumPlayers(), getNumPlayers() == 0 ? null : this.players.getPlayerName(this.currentTurn), this.getRemainingTiles(), this.players, this.currentTurn));
	}
	...
	public JSONObject getRegistration() {
		return GameSerializer.serializeRegister(board, this.getNumPlayers(), this.players, currentTurn);
	}
}
